...
export function injectChatbot() {
  ...
  toggle.style.cssText = "position:fixed;bottom:1.25rem;right:1.25rem;z-index:60;width:52px;height:52px;border-radius:50%;background:linear-gradient(135deg,var(--gold-soft),var(--gold) 55%,var(--gold-dim));border:none;cursor:pointer;box-shadow:0 6px 24px rgba(0,0,0,.4);display:flex;align-items:center;justify-content:center;color:#0a0f1d;";
  toggle.innerHTML = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>`;

  const panel = document.createElement("div");
  panel.id = "chatbot-panel";
  panel.className = "hidden";
  panel.style.cssText = "position:fixed;bottom:5rem;right:1.25rem;z-index:60;width:min(340px, calc(100vw - 2.5rem));max-height:min(480px, calc(100vh - 8rem));display:flex;flex-direction:column;border-radius:1rem;overflow:hidden;box-shadow:0 12px 40px rgba(0,0,0,.5);";
  panel.innerHTML = `
  ...
  document.getElementById("chatbot-close").addEventListener("click", () => panel.classList.add("hidden"));
